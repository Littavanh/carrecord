  ...
  if (isset($_POST["btnChangePass"])) {
    ...
    $Set_userName = $_SESSION['username'];
    ...
    $passmd5 = md5($txtConpassword . '1it@v@nh' . $Set_userName);
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-user"></i>
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-default" aria-labelledby="navbarDropdownMenuLink-333">
            ...
            <a class="dropdown-item" data-toggle="modal" data-target="#modal-ChangePass" href="#"><i class="fas fa-edit"></i> ປ່ຽນລະຫັດຜ່ານ</a>
          </div>
        </li>
      </ul>
    </ul>
