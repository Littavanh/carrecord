            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">ເພີ່ມຍີ່ຫໍ້ພາຫະນະໃຫມ່</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <form method="post" action="?d=master/carbrand" enctype="multipart/form-data">
                  <div class="modal-body">
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>ຍີ່ຫໍ້ພາຫະນະ</label>
                          <input type="text" Name="txtBrand" class="form-control" required="">
                      ...
                      ?>
                          <div class="modal fade" id="modal-lg-Edit<?= $i ?>">
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title">ແກ້ໄຂຂໍ້ມູນຍີ່ຫໍ້</h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="row">
                                      <div class="col-sm-6">
                                        <div class="form-group">
                                          <label>ຍີ່ຫໍ້ພາຫະນະ</label>
                                          <input type="text" name="txtBrand" class="form-control" required="" value="<?= $row['brand'] ?>">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                          ...
                          <tr>
                            ...
                            <td align="center">
                              <a href="?d=master/carbrand&del=<?= $row['id'] ?>" onclick="return confirm('ທ່ານຕ້ອງການລຶບແທ້ບໍ...?')"><i class="far fa-trash-alt"></i></a>
                            </td>
                          </tr>
                      <?php
                          $i++;
