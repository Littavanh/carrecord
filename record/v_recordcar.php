                                                    ...
                                                    while ($row = $result->fetch_assoc()) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="eqcodecols">
                                                                ...
                                                                <input type="date" name="txtDate[]" size="" value="<?= $row['date'] ?>" required />

                                                            </td>
                                                            <td class="eqcodecols">
                                                                <input type="time" name="txtTime_start[]" size="" value="<?= $row['time_start'] ?>" required />
                                                            </td>
                                                            <td class="eqcodecols">
                                                                <input type="time" name="txtTime_end[]" size="" value="<?= $row['time_end'] ?>" required />
                                                            </td>

                                                            <td class="eqcodecols">
                                                                <!-- <input type="text"  name="txtDriver[]" value="<?= $row['name'] ?> <?= $row['surname'] ?>"> -->
                                                            ...
                                                            <td class="eqcodecols">
                                                                <input type="text" name="txtMeter_start[]" size="" value="<?= $row['meter_start'] ?>" required />
                                                            </td>
                                                            <td class="eqcodecols">
                                                                <input type="text" name="txtMeter_end[]" size="" value="<?= $row['meter_end'] ?>" required />
                                                            </td>
                                                            <td class="eqcodecols">
                                                                <input type="text" name="txtRemark[]" size="" value="<?= $row['remark'] ?>" />
                                                            </td>
                                                            <td class="centered">
    ...
    <table class="template hidden" id="tab">
        <tr>
            ...
            <td class="eqcodecols">
                ...
                <input type="date" name="txtDate[]" size="" value="" required />
            </td>
            <td class="eqcodecols">
