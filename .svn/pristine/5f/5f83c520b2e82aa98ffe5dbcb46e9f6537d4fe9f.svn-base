            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <form method="get">
                            <input type="hidden" name="d" value="report/rRecordCarAll1" />
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <label>ເດືອນ</label>
                                        <input type="number" name="month" min="1" max="12" step="1" class="form-control" autocomplete="off" value="<?= $_SESSION['month'] == null ? 1 : $_SESSION['month'] ?>" required="required">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>ຕາມພາກສ່ວນ</label>
                                        <select class="form-control" name="cb_bu">
                                            ...
                                            <?php
                                            $bu = "SELECT * FROM tb_business $where";
                            ...
                            <div class="box-footer">
                                <button type="reset" class="btn btn-default" onclick="document.location='?d=report/rRecordCarAll1'">ຍົກເລີກ</button>
                                <button type="submit" class="btn btn-primary">ຄົ້ນຫາ</button>
                                <?php if ($_GET['year'] != '' && $_GET['month'] != '') { ?>
                                    <a href="report/ex_rRecordCarAll1.php?year=<?= $_GET['year'] ?>&month=<?= $_GET['month'] ?>" target="_blank">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                if ($result = $mysqli->query($report)) {
                                                                    while ($row = $result->fetch_assoc()) {
                                                                        ...
                                                                        // if ($row['kmUsage1'] != 0 && $row['amount'] != 0) {
